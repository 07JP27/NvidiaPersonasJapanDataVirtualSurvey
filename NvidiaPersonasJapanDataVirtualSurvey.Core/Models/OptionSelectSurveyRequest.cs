...
public class OptionSelectSurveyRequest(string query, List<string> options, bool isMultiSelect=false) : ISurveyRequest
{
    public string GetUserPrompt()
    {
        ...
        {(isMultiSelect ? "一つ以上" : "一つだけ")}選んで答えてください。
        """;
    }
    ...
    public string GetSystemPrompt(PersonaRecord persona)
    {
        ...
        return $"""
        以下のペルソナになりきって、ユーザーから送信される質問に対して選択肢肢の中から{(isMultiSelect ? "一つ以上" : "一つだけ")}選んで答えてください。
